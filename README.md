...
## 3.　ゲーム起動までの手順  
　　3-1.　パッケージをインポート  
  　　　unityがプロジェクト画面の状態(1-4)で手順2でダウンロードしたtenjigo.unitypackageを開きインポートする。  
　  
　　3-2.　シーンの統合を行う  
...
　　3-3.　タイトルシーンからゲームスタート  
  　　　Sceneフォルダのタイトルシーンからゲームスタートnew_titleをダブルクリックしてタイトルシーンを開く。この  
     　　　画面で上部の「▶︎」ボタンをクリックするとゲームを開始することができる。  
